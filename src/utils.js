...
export function dashLine(x, y, x2, y2, da) {
    if(!da) {
        da = [10, 5];
    }
    this.save();
...
export function dashRect(x, y, dx, dy, da) {
    this.beginPath();
...
export function drawPixel(x, y, r, g, b, width) {
...
export function drawPixelLine(x1, y1, x2, y2, r, g, b, width) {
...
export function getNewId(counterName) {
...
export function setIdCounters(counters) {
    idCounters = counters;
}
...
export function getMousePosition(event, domElement) {
...
export function readGlobalMouse(event) {
    var result = {};
...
export function HSLValue(n1, n2, hue) {
    var val;
    if(hue > 6) {
        hue -= 6;
    }
